...
export default {
  ...
  'Doesnt Call onBeforeMount Or onAfterMount When A Component Renders Itself'(browser: NightwatchBrowser) {
    browser
      .url(server.domain)
      .waitForElementVisible('body', 2000)
  ...
  'Doesnt Call onBeforeMount Or onAfterMount When A Component Renders From An Outside Trigger'(browser: NightwatchBrowser) {
    browser
      .url(server.domain)
      .waitForElementVisible('body', 2000)
  ...
  'Doesnt Call onBeforeReplace Or onAfterReplace When A Component Renders For The First Time'(browser: NightwatchBrowser) {
    browser
      .url(server.domain)
      .waitForElementVisible('body', 2000)
    browser.execute(() => window['counts'], [], (result) => {
  ...
  'Calls onBeforeReplace And onAfterReplace When A Component Is Given New Arguments'(browser: NightwatchBrowser) {
    browser
      .url(server.domain)
      .waitForElementVisible('body', 2000)
      .click('#increment-button')
